...
import com.chatio.databinding.FragmentSmsBinding
...
class SmsFragment : Fragment() {
        ...
        lifecycleScope.launch {
            try {
                val contacts = withContext(Dispatchers.IO) {
                    ...
                    val smsContacts = SmsReader.readSmsHistory(requireContext())
                ...
                if (_binding != null) {
                    ...
                    if (contacts.isEmpty()) {
                        binding.emptyTextView.text = if (isFiltered) getString(R.string.no_messages_filtered) else getString(R.string.no_messages)
    ...
    fun refresh() {
        if (_binding != null) {
         ...
         // Eğer binding null ise (view henüz oluşmadıysa), onViewCreated zaten loadSmsHistory çağıracak
    }
